...
let login = function* (options) {
  ...
  .insert('input[id="CustPermIDAux"]', options.rutCompany.replace(/-/g, ''))
  .insert('input[id="CustLoginIDAux"]', options.rutUser.replace(/-/g, ''))
  .insert('input[id="SignonPswdAux"]', options.password.replace(/-/g, ''))
...
function crawlBancoEstadoGetTransactions (opts) {
